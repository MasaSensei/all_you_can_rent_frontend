...
export default function CouponsPage() {
  ...
  const columns: Column<Coupon>[] = [
    ...
    },
    {
      ...
      cell: (row) =>
        row.valid_to ? (
          <span
            className={`text-sm ${new Date(row.valid_to) < new Date() ? "text-red-500" : "text-slate-600"}`}
          >
      ...
      cell: (row) => (
        <div className="flex items-center justify-end gap-1">
          ...
          <ConfirmDialog
            ...
            title="Hapus Kupon"
            description={`Kupon "${row.code}" akan dihapus.`}
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title="Kupon"
        description="Kelola kode diskon untuk booking"
      ...
      <DataTable
        ...
        emptyDescription="Buat kupon diskon untuk menarik lebih banyak customer."
      />
      {modal && (
        <CouponModal
