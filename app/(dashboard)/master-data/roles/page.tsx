        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Akses operasional sehari-hari"
              className={inp}
            />
          </div>
      ...
      <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <div key={module}>
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {perms.map((perm) => (
                  <label
                    key={perm.id}
                    className="flex items-center gap-2 cursor-pointer rounded-lg border border-slate-200 px-3 py-2 hover:bg-slate-50"
                  >
                    <input
                      type="checkbox"
        ...
        <div className="border-t border-slate-200 flex items-center justify-between px-6 py-4">
          <span className="text-sm text-slate-500">
            {selected.size} permission dipilih
          </span>
...
export default function RolesPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {permModal && (
        <PermissionModal role={permModal} onClose={() => setPermModal(null)} />
      )}
    </div>
  );
}
